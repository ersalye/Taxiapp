...
import com.tranzeet.app.ui.countrypicker.CountryPicker;
...
public class RegisterActivity extends BaseActivity implements RegisterIView {
    ...
    private String countryDialCode = "+254";
...
//        map.put("countryCode", SharedHelper.getKey(this, "countryCode"));
    ...
    public void onSuccess(RegisterResponse response) {
        ...
        Toast.makeText(this, getString(Integer.parseInt(""+response.getAccessToken())), Toast.LENGTH_SHORT).show();
